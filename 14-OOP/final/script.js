...
// acc1.__movements.push(250);
// acc1.__movements.push(-140);
...
// Student.prototype.introduce = function () {
// console.log(`Hi my mane is ${mike.firstName} and i study ${mike.course}`);
// };
...
const jay = Object.create(StudentProto);
jay.init('Jay', 2012, 'Computer Sicience');
jay.calcAge();
...
// console.log(acc1.getMovements(), acc1.getPin());
...
const Toyota = new EV('Toyota', 100, 50);

// console.log(Toyota.accelerate().brake().accelerate().chargeBattery(90));
